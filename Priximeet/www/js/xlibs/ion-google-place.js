    ...
    .directive('ionGooglePlace', [
        ...
        function($ionicTemplateLoader, $ionicBackdrop, $ionicPlatform, $q, $timeout, $rootScope, $document) {
            return {
                require: '?ngModel',
                restrict: 'E',
                template: '<input type="text" readonly="readonly" class="theme-border" autocomplete="on">',
                replace: true,
                scope: {
                    ngModel: '=?',
                    geocodeOptions: '='
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    var POPUP_TPL = [
                        '<div class="ion-google-place-container modal" style="display:none">',
                            '<div class="bar bar-header item-input-inset">',
                                '<label class="item-input-wrapper">',
                                    '<i class="ion-ios-search-strong"></i>',
                                    '<input  type="search" ng-model="searchQuery" placeholder="' + (attrs.searchPlaceholder || 'Enter an address') + '">',
                                '</label>',
