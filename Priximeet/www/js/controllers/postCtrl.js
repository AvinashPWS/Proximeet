angular.module('ionicApp.postCtrl', [])
        .controller('postCtrl', function ($q, $cordovaDatePicker, $scope, userLogin, $rootScope, $ionicPopup, $templateCache, $ionicPlatform, $ionicHistory, $ionicModal, $state
            ...
            //Moved from line no. 527 to here, as $scope was not access able for this function on line no. 527.
            ...
            $scope.fromTimeTrig = function () {
                customDatePick.getDateTime("from", "time", {
                    date: $scope.data.fromDate,
                    time: $scope.data.fromTime,
                    direction: "from"
                }).then(function (time) {
            ...
            $scope.toTimeTrig = function () {
                ...
                customDatePick.getDateTime("to", "time", {
                    date: $scope.data.toDate,
                    time: $scope.data.toTime,
                    direction: "to"
                }).then(function (time) {
            ...
            function fileCall(file, postVals) {
                ...
                function  postwithfile() {
                    ...
                    //ft.upload(file, "http://78.47.154.117/proximeet/posts/post.json", win, fail, options);
